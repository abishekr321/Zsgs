...
<%@page import="com.coursemanagement.model.Model"%>
...
<body
	...
	<h1 style="text-align: center; color: #330066; text-decoration: blink;">Teacher
		Registration</h1>
	<div
		...
		<form action="/CourseManagement/RegistersTeachers" onsubmit="return validateteacher()"
			method="post">
			...
			%>
			Select Subject:<br> <select class="in" name="subject" required>
				<option value="" selected>choose</option>
				<%
				for (CourseDetails courses : courseDetails) {
				%>
				<option value="<%=courses.getCourseId()%>">
					<%=courses.getCourseId()%> -
					<%=courses.getCourseName()%></option>
				<%
				}
				%>
			</select><br>
			...
			<br> Re-Enter Password<br> <input class="in"
				type="password" name="rePassword"><br>
