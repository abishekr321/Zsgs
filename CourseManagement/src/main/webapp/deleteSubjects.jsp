...
<% ResultSet set =(ResultSet)request.getAttribute("deleteCourses");  %>
...
<%while(set.next()){
	...
	<td>
	<a href="DeleteSubjects?courseId=<%=set.getString(1) %>"><img src="Images/delete.png" width="20px" height="20px"> </a>
	</td>
	</tr>
	<%
}
