...
<form action="TeacherLogin" method="post" onsubmit="return validateLogin()">
<%if(!(session.getAttribute("newteacherId")==null)){
 %>
 <div style="color: green;font-weight: bold;">User Id: <%=(String)session.getAttribute("newteacherId") %></div>
...
<a href="registerteacher.jsp">Create an account</a><br> 
</form>
</div>
</body>
<script>
